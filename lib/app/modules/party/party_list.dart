...
import 'package:song_voter/app/data/services/party_service.dart';
...
class _PartyListWidgetState extends State<PartyListWidget> {
  ...
  final PartyService _partyService = PartyService.instance;
  ...
  Future _loadParties() async {
    final parties = await _partyService.allParties();
